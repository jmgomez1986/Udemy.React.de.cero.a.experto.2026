...
import {
  getInitialScrambleWordsState,
  scrambleWordsReducer,
} from './reducer/srcrumbleWordsReducer';

export const ScrumbleWordsWithReducer = () => {
  ...
  const handlePlayAgain = () => {
    dispatch({
      type: 'START_NEW_GAME',
      payload: { state: getInitialScrambleWordsState() },
    });
  };
                ...
                <div>
                  ...
                  <Input
                    ...
                    onChange={(e) =>
                      dispatch({
                        type: 'SET_GUESS',
                        payload: { guess: e.target.value.toUpperCase().trim() },
                      })
                    }
