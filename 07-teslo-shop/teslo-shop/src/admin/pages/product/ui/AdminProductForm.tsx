...
export const AdminProductForm = ({
  ...
  const {
    register,
    handleSubmit,
    formState: { errors }, // Devolver el estado del formulario, en este caso, los errores
    getValues, // Obtener algun valor del formulario
    setValue, // Setear valores manualmente al formulario
    watch, // Para estar pendientes a cambios del formulario y disparar re renders
  } = useForm({
  ...
  const addTag = () => {
    // console.log(inputTagRef.current?.value);
  ...
  const addSize = (size: Size) => {
    ...
    sizeSet.add(size); // Agrega el size si no existe, si ya existe no lo agrega, porque cada valor es unico
    setValue('sizes', Array.from(sizeSet)); // Como espera un arreglo, se convierte el Set en un Array
  };
            ...
            <div className='bg-white rounded-xl shadow-lg border border-slate-200 p-6'>
              ...
              <div className='space-y-4'>
                ...
                <div className='flex flex-wrap gap-2 pt-2 border-t border-slate-200'>
                  ...
                  {availableSizes.map((size) => (
                    <button
                      type='button' // Hay que agregar el  type porque si no todos los botones hacen un post del formulario
                      key={size}
            ...
            <div className='bg-white rounded-xl shadow-lg border border-slate-200 p-6'>
              ...
              <div className='space-y-4'>
                ...
                <div className='flex items-center justify-between p-3 bg-slate-50 rounded-lg'>
                  ...
                  <span
                    className={`px-2 py-1 text-xs font-medium rounded-full ${getStockInfo(currentStock).className}`}
                  >
                    {getStockInfo(currentStock).text}
                  </span>
                </div>
